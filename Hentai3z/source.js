...
var _Sources = (() => {
  ...
  var SITE_BANNED_LABELS = /\btrap\b|\bfemboy\b|\botokonoko\b|\bcatboy\b|\b(?:fox|bunny|shark|mouse|squid|racc?oon|monkey|lizard|deer|squirrel|sheep)\s*(?:boy|man)\b/i;
...
Please go to the homepage of <${Hentai3zInfo.name}> and press the cloud icon.`);
    ...
    tilesFrom(candidates, seen, serials, filters2) {
      ...
      for (const candidate of candidates) {
        ...
        if (candidate.refused || inspection == void 0) continue;
        if (inspection.chapters.length === 0 || !this.matches(inspection, filters2)) continue;
